...
namespace Zone8.Core.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "Zone8/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "Zone8/Don't Load Bootstrap Scene On Play";
